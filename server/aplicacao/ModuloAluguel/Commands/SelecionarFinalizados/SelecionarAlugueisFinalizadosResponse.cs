...
public record SelecionarAlugueisFinalizadosDto(Guid Id, Cliente Cliente, Condutor Condutor, Automovel Automovel, Plano Plano, List<Taxa> Taxas, DateTimeOffset DataSaida, DateTimeOffset DataRetornoPrevista,

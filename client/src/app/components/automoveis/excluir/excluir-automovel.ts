...
import { DetalhesAutomovelModel } from '../automovel.models';

@Component({
  selector: 'app-excluir-automovel',
  imports: [
    MatCardModule,
    MatButtonModule,
    MatIconModule,
  ...
  templateUrl: './excluir-automovel.html',
})
export class ExcluirAutomovel {
  ...
  public excluir() {
    ...
    this.automovel$
      .pipe(
        take(1),
        switchMap((automovel) => this.automovelService.excluir(automovel.id))
      )
